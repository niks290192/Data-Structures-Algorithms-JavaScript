/* 
Pattern matching is case insensitive as the inputs are converted to lower 
case before the algorithm is run.

The algorithm will run through the entire text and return the starting index if
the given pattern is available in the text.
...
const checkIfPatternExists = (text, pattern) => {
    ...
    // Iterate throuth the text until the textlength - patternLength index
