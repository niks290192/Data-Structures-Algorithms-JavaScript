/* 
    A permutation of a set is, loosely speaking, an arrangement of its member into a sequence or linear order, or if the set is already ordered, a rearragnement of its elements. 
